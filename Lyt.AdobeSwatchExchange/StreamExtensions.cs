...
internal static class StreamExtensions
{
    ...
    public static unsafe float ReadSingleBigEndian(this Stream stream)
    {
        int value = stream.ReadUInt32BigEndian();
        return *(float*)&value;
    }

    /// <summary> Reads a ASCII string of the specified length. </summary>
    /// <param name="stream">The stream to read the data from.</param>
    ...
    /// <summary> Reads a unicode string of the specified length in big-endian format. </summary>
    /// <param name="stream">The stream to read the data from.</param>
    /// <param name="length">The number of characters in the string.</param>
    /// <returns>The string read from the stream.</returns>
    ...
    /// <summary>
    /// Reads a unicode string from the current stream in big-endian format. 
    ...
    public static string ReadStringBigEndian(this Stream stream)
    {
        ...
        int length = stream.ReadUInt16BigEndian() - 1;
        string value = stream.ReadStringBigEndian(length);
    ...
    /// <param name="stream">The stream to write the data to.</param>
    /// <param name="value">The value to write</param>
    public static unsafe void WriteBigEndian(this Stream stream, float value)
